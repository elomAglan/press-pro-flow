...
// --- Fonctions utilitaires (à remplacer par ton vrai client/service) ---
const getClientName = (clientId: string) => clientId; // TODO: remplacer par fetch ou mapping réel
    ...
    useEffect(() => {
        async function fetchCommandes() {
            try {
                ...
                // Assure-toi que les dates sont des objets Date
